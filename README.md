# BAD DAO
A unified ecosystem for the BAD DAO protocol.
...
The older version of BAD DAO Factory targeting EVM-compatible networks is stored under `contracts-evm/`. It contains robust, highly-tested Foundry contracts representing the original architecture before the pivot to Stellar.
