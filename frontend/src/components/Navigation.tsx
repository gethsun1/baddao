...
export default function Navigation() {
  return (
    <nav className="fixed top-0 w-full glass z-50 border-b border-communityCorner-border/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-4">
            <Link 
              href="/" 
              className="hidden md:flex px-4 py-2 text-sm font-semibold text-communityCorner-primary bg-white rounded-full hover:bg-gray-100 transition-colors"
            >
              Create DAO
            </Link>
            <WalletConnect />
