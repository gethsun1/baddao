  ...
  return (
    <div className={cn("glass p-6 rounded-2xl border-white/5", className)}>
      <div className="flex items-center gap-4">
        {icon && (
          <div className="w-12 h-12 rounded-xl bg-communityCorner-primary flex items-center justify-center text-communityCorner-highlight border border-communityCorner-border/50">
            {icon}
          </div>
        )}
        <div>
