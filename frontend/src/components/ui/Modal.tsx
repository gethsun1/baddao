      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          <motion.div
            ...
            exit={{ opacity: 0 }}
            onClick={onClose}
            className="fixed inset-0 bg-communityCorner-primary/80 backdrop-blur-sm"
          />
          <motion.div
          ...
          >
            <Card className="p-6 sm:p-8 flex flex-col shadow-2xl border-communityCorner-border/80 text-left bg-communityCorner-card/95 backdrop-blur-xl">
