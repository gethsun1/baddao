    ...
    <Card variant="metallic" hoverEffect className="flex flex-col h-full">
      ...
      <div className="space-y-4 mt-6">
        <div className="space-y-2">
          ...
          <div className="h-2 bg-communityCorner-primary rounded-full overflow-hidden">
            <motion.div 
              className="h-full bg-communityCorner-highlight" 
              initial={{ width: 0 }}
      ...
      <div className="border-t border-communityCorner-border/50 mt-4 pt-3 flex items-center gap-2 text-xs text-gray-500">
        <Clock size={14} />
