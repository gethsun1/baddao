  ...
  return (
    <div className="space-y-12 relative overflow-hidden">
      ...
      <Section className="flex flex-col items-center justify-center pt-32 pb-16 min-h-[80vh] relative z-10 text-center md:text-left">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-communityCorner-accent/10 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 md:gap-8 max-w-6xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-communityCorner-highlight/30 bg-communityCorner-highlight/10 text-communityCorner-highlight text-sm font-medium mb-4">
            ...
            <p className="text-xl text-gray-400 font-light leading-relaxed max-w-lg mx-auto md:mx-0">
              Community Corner DAO Factory enables anyone to create and operate decentralized organizations on Stellar with integrated governance, treasury management, and on-chain execution.
            </p>
      ...
      <AnimatePresence>
        {step > 0 && !done && (
          ...
          >
            <Card className="p-8 sm:p-10">
              <div className="mb-8 border-b border-communityCorner-border pb-6 flex items-center gap-4">
                <div className="w-12 h-12 rounded-xl bg-communityCorner-primary border border-communityCorner-border flex items-center justify-center text-communityCorner-accent">
                  <Settings size={24} />
                </div>
                <div>
        ...
        {done && (
          ...
          >
            <Card className="p-10 text-center space-y-6 bg-communityCorner-card/50 border-green-500/30">
              ...
              {deployedGovernor && (
                <div className="p-4 bg-communityCorner-primary rounded-xl border border-communityCorner-border break-all">
      ...
      <Section id="capabilities" className="py-24 border-t border-communityCorner-border/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <Card className="p-8 hover:border-communityCorner-accent/50 transition-colors">
            <div className="w-12 h-12 bg-communityCorner-accent/10 rounded-xl flex items-center justify-center text-communityCorner-accent mb-6">
              <Boxes size={24} />
            </div>
      ...
      {/* How It Works */}
      <Section id="how-it-works" className="py-24 bg-communityCorner-card/30 rounded-3xl border border-communityCorner-border/50">
        <div className="text-center mb-16">
        ...
        <div className="max-w-5xl mx-auto px-4 relative">
          <div className="hidden md:block absolute top-[45px] left-[10%] right-[10%] h-0.5 bg-communityCorner-border z-0" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            {[
              ...
              <div key={i} className="relative z-10 flex flex-col items-center text-center group">
                <div className="w-24 h-24 rounded-2xl bg-communityCorner-primary border-2 border-communityCorner-border flex items-center justify-center mb-6 group-hover:border-communityCorner-accent transition-colors shadow-lg shadow-black/50">
                  <span className="font-display font-bold text-2xl text-white group-hover:text-communityCorner-accent transition-colors">{step.num}</span>
                </div>
      ...
      <Section className="py-24">
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-communityCorner-primary to-communityCorner-card border border-communityCorner-border rounded-3xl p-10 md:p-16 text-center shadow-2xl relative overflow-hidden">
          <div className="absolute top-0 right-0 p-8 opacity-10 blur-xl">
            <Code2 size={200} className="text-communityCorner-accent" />
          </div>
