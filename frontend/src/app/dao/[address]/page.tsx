  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 pt-8 pb-20 min-h-[calc(100vh-80px)] animate-in fade-in duration-700">
      ...
      <aside className="w-full md:w-64 shrink-0 space-y-6">
        <div className="glass p-6 rounded-2xl border border-communityCorner-border text-center md:text-left">
          ...
          {tabs.map((tab) => (
            <button
              ...
              className={cn(
                ...
                activeTab === tab.id
                  ? "bg-communityCorner-accent/10 border border-communityCorner-accent/30 text-communityCorner-highlight"
      ...
      <main className="flex-1 space-y-8 min-w-0">
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                <button 
                  ...
                  className="text-sm text-gray-400 hover:text-communityCorner-highlight transition-colors"
                >
                  View All
                </button>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {!proposals?.length ? (
                  <div className="col-span-1 md:col-span-2 glass p-8 rounded-2xl text-center text-gray-500 border border-communityCorner-border/50">
                    No proposals yet.
                  </div>
                ) : (
                  // eslint-disable-next-line @typescript-eslint/no-explicit-any
        ...
        {activeTab === 'proposals' && (
          <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-500">
            {!proposals?.length ? (
              <div className="glass p-16 rounded-3xl text-center text-gray-500 border border-communityCorner-border/50">
        ...
        {(activeTab === 'members' || activeTab === 'treasury' || activeTab === 'settings') && (
          <div className="glass p-16 rounded-3xl border border-communityCorner-border/50 flex flex-col items-center justify-center text-gray-500 animate-in slide-in-from-bottom-4 duration-500 h-[400px]">
